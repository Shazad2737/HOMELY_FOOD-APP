...
import 'package:homely_api/homely_api.dart' as homely_api;
import 'package:homely_app/app/view/bloc_providers.dart';
import 'package:homely_app/auth/bloc/auth_bloc.dart';
import 'package:homely_app/router/router.dart';
...
class App extends StatefulWidget {
  const App({required this.api, required this.releaseMode, super.key});

  final homely_api.IHomelyApi api;
...
class _AppState extends State<App> {
  ...
  Widget build(BuildContext context) {
    final multiBlocProvider = MultiRepositoryProvider(
      providers: [
        RepositoryProvider(create: (context) => widget.api.cmsRepository),
        RepositoryProvider(create: (context) => widget.api.authFacade),
        RepositoryProvider(create: (context) => widget.api.menuRepository),
        RepositoryProvider(
          create: (context) => widget.api.notificationRepository,
        ),
        RepositoryProvider(create: (context) => widget.api.userRepository),
        RepositoryProvider(
          ...
          builder: (context) {
            return MaterialApp.router(
              ...
              routerConfig: appRouter.config(
                ...
                navigatorObservers: () {
                  return [RouteLogObserver(), AutoRouteObserver()];
                },
