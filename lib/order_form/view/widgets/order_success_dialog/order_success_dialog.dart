          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...() {
                    final sortedOrderItems =
                        List<OrderItem>.from(order.orderItems)..sort(
                          (a, b) => a.mealType.type.index.compareTo(
                            b.mealType.type.index,
                          ),
                        );
                    return [
                      for (final item in sortedOrderItems) ...[
                        OrderItemRow(
                          item: item,
                          mealSelections: mealSelections,
                        ),
                        if (item != sortedOrderItems.last)
