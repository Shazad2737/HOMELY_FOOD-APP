...
#### **Directory Structure**
```
packages/homely_api/lib/src/subscription/
  ├── models/
...
> **Note**: We use `MealSubscription` instead of `MealType` to avoid naming conflict with the existing `MealType` enum in `packages/homely_api/lib/src/menu/models/meal_type.dart`.

#### **1.1.1 Meal Subscription Model**
**File**: `packages/homely_api/lib/src/subscription/models/meal_subscription.dart`
...
**File**: `packages/homely_api/lib/src/subscription/models/subscription_contact.dart`
...
**File**: `packages/homely_api/lib/src/subscription/models/subscription_data.dart`

```dart
import 'package:deep_pick/deep_pick.dart';
import 'package:equatable/equatable.dart';
import 'package:homely_api/src/cms/models/banner.dart';
import 'package:homely_api/src/subscription/models/meal_subscription.dart';
...
**File**: `packages/homely_api/lib/src/subscription/models/models.dart`
...
**File**: `packages/homely_api/lib/src/subscription/subscription_facade_interface.dart`
...
**File**: `packages/homely_api/lib/src/subscription/subscription_repository.dart`
...
import 'package:fpdart/fpdart.dart';
import 'package:homely_api/src/subscription/models/models.dart';
import 'package:homely_api/src/subscription/subscription_facade_interface.dart';
...
**File**: `packages/homely_api/lib/src/subscription/subscription.dart`
...
**File**: `packages/homely_api/lib/homely_api.dart`
...
### 1.4 Expose Subscription Facade in HomelyApi
...
1. **Import** at the top:
```dart
import 'package:homely_api/src/subscription/subscription.dart';
```
...
import 'package:homely_app/subscriptions/view/widgets/subscription_card.dart';
...
**File**: `packages/homely_api/test/subscription/models/meal_subscription_test.dart`
...
### Phase 1: API Layer (packages/homely_api)
- [ ] Create `packages/homely_api/lib/src/subscription/` directory
...
- [ ] Update `homely_api.dart` to export subscription module
- [ ] Add `subscriptionFacade` getter to `HomelyApi` class
