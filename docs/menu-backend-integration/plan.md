...
│                         ▼                                    │
│  ┌─────────────────────────────────────────────────────┐   │
│  │  MenuRepository (instamess_api package)              │   │
...
All models will be created in: `packages/instamess_api/lib/src/menu/models/`
...
**File**: `packages/instamess_api/lib/src/menu/models/models.dart`
```dart
...
**Current**: `packages/instamess_api/lib/src/cms/models/category.dart` contains `Plan` class

**Action**: Extract `Plan` to separate file

**New Structure**:
```
packages/instamess_api/lib/src/cms/models/
  ├── area.dart
  ├── banner.dart
...
```
packages/instamess_api/lib/src/common/models/
...
**File**: `packages/instamess_api/lib/src/menu/menu_repository_interface.dart`
...
**File**: `packages/instamess_api/lib/src/menu/menu_repository.dart`
...
```dart
// Add import
import 'package:instamess_api/src/menu/menu.dart';

// In IInstaMessApi interface, add:
abstract class IInstaMessApi {
  // ... existing methods
  IMenuRepository get menuFacade;
}

// In InstaMessApi implementation:
...
**File**: `packages/instamess_api/lib/src/menu/menu.dart`
...
**Update**: `packages/instamess_api/lib/instamess_api.dart`
...
### 7.1 Package Layer (`packages/instamess_api`)
...
- [ ] Update `instamess_api.dart` to add `IMenuRepository` getter
- [ ] Update `instamess_api.dart` to initialize `MenuRepository`
- [ ] Update main export `instamess_api.dart` to export menu module
...
5. Update InstaMessApi to expose menu repository
