...
import 'package:homely_api/homely_api.dart' show ISessionManager;
import 'package:homely_api/src/auth/models/models.dart';
import 'package:homely_api/src/session/i_session_manager.dart'
    show ISessionManager;
import 'package:homely_api/src/session/session.dart' show ISessionManager;
...
abstract class IAuthFacade {
  ...
  /// Initiates forgot password flow by generating OTP
  ///
  /// Returns success message if successful, otherwise [Failure]
  ...
  ///
  /// Returns [String] token if successful, otherwise [Failure]
  Future<Either<Failure, String>> verifyResetOtp({
    required String mobile,
    required String otp,
  });

  /// Resets password using the token received from [verifyResetOtp]
  ///
  /// Returns success message if successful, otherwise [Failure]
